...
b2dJsonImage* b2dJson::j2b2dJsonImage(Json::Value imageValue)
{
    ...
    sysLog.Log("Checking for file.....");
    sysLog.Log("In b2dJsonImage* b2dJson::j2b2dJsonImage(Json::Value imageValue)");
    if(!img->fileExists(&img->file))
    {
        sysLog.Log(img->file+" = File does not exist");
    }
