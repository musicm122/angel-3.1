...
bool RubeLoader::addPhysicsActor(PhysicsActor actor, int layer)
{
    //not sure the best way to do this.Cast or instantiate a renderable?
    //theWorld.Add((Renderable*)actor,layer);
    return false;
}
